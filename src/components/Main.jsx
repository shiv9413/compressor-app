            ...
            <section className="hero text-light text-center">
                <div className="container-sm">
                    <div className="hero-inner">
                        <h1 className="hero-title h2-mobile mt-0 is-revealing" style={{ visibility: 'visible' }}>Streamlining PDFs for Seamless Use.</h1>
                        <p className="hero-paragraph is-revealing" style={{ visibility: 'visible' }}>Unlock Efficiency: Essential Tools for Smart Document Management.</p>
                        <p className="hero-cta is-revealing" style={{ visibility: 'visible' }}><a className="button button-secondary button-shadow" href="#">See All PDF Tools</a></p>
                    ...
                    <div className="clients-inner section-inner has-top-divider">
                        <div className="container-sm">
                            <ul className="list-reset mb-0">
                                ...
                                <li>
                                    <span className="screen-reader-text">Dell</span>
                                    <svg width="132" height="40" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    <span className="screen-reader-text">Uber</span>
                                    <svg width="132" height="40" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="features-wrap">
                            <div className="feature is-revealing" style={{ visibility: 'visible' }}>
                                <div className="feature-inner">
                                    ...
                                    <p className="text-sm">often arouses curiosity due to its resemblance to classNameical latin</p>
                                </div>
                            </div>
                            <div className="feature is-revealing" style={{ visibility: 'visible' }}>
                                <div className="feature-inner">
                            ...
                            <div className="feature is-revealing" style={{ visibility: 'visible' }}>
                                <div className="feature-inner">
                                    <div className="feature-icon">
                                        <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg">
                                            <g fill="none" fill-rule="evenodd">
                                                <path d="M32 40H0c0-8.837 7.163-16 16-16s16 7.163 16 16z" fill="#84E482" style={{ mixBlendMode: 'multiply' }}/>
                ...
                <div className="container">
                    <div className="features-extended-inner section-inner has-top-divider">
                        ...
                        <div className="feature-extended">
                            <div className="feature-extended-image is-revealing" style={{ visibility: 'visible' }}>
                                <svg width="480" height="360" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path fill="#FFF" d="M40 50h400v260H40z" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-1)' }}/>
                                    <path fill="#FFF" d="M40 50h400v260H40z"/>
                                    <path fill="#FFF" d="M103 176h80v160h-80zM320 24h88v88h-88z" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-1)' }}/>
                                    <path fill="#FFF" d="M103 176h80v160h-80zM320 24h88v88h-88z"/>
                                    <path fill="#FFF" d="M230.97 198l16.971 16.971-16.97 16.97L214 214.972z" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-1)' }}/>
                                    <path fill="#02C6A4" d="M230.97 198l16.971 16.971-16.97 16.97L214 214.972z"/>
                                    <path fill="#FFF" d="M203 121H103v100z" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-1)' }}/>
                                    <path fill="#84E482" d="M203 121H103v100z"/>
                                    <circle fill="#FFF" cx="288" cy="166" r="32" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-1)' }}/>
                                    <circle fill="#0EB3CE" cx="288" cy="166" r="32" style={{ mixBlendMode: 'multiply' }}/>
                                </svg>
                            </div>
                        ...
                        <div className="feature-extended">
                            <div className="feature-extended-image is-revealing" style={{ visibility: 'visible' }}>
                                <svg width="480" height="360" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path fill="#FFF" d="M40 50h400v260H40z" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-2)' }}/>
                                    <path fill="#FFF" d="M40 50h400v260H40z"/>
                                    <path fill="#FFF" d="M86.225 161l62.226 62.225-62.226 62.225L24 223.225zM296 176h80v160h-80z" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-2)' }}/>
                                    <path fill="#FFF" d="M86.225 161l62.226 62.225-62.226 62.225L24 223.225zM296 176h80v160h-80z"/>
                                    <path fill="#FFF" d="M245.092 218l9.378 22.092-22.093 9.378L223 227.378z" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-2)' }}/>
                                    <path fill="#02C6A4" d="M245.092 218l9.378 22.092-22.093 9.378L223 227.378z"/>
                                    <path fill="#FFF" d="M270 96H170v100z" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-2)' }}/>
                                    <path fill="#84E482" d="M270 96H170v100z"/>
                                    <circle fill="#FFF" cx="296" cy="177" r="32" style={{ mixBlendMode: 'multiply', filter: 'url(#dropshadow-2)' }}/>
                                    <circle fill="#0EB3CE" cx="296" cy="177" r="32" style={{ mixBlendMode: 'multiply' }}/>
                                </svg>
                            </div>
                            <div className="feature-extended-body">
                                <h3 className="mt-0">Discover</h3>
                ...
                <div className="container">
                    <div className="pricing-inner section-inner has-top-divider">
                        ...
                        <div className="pricing-tables-wrap">
                            <div className="pricing-table is-revealing" style={{ visibility: 'visible' }}>
                                <div className="pricing-table-inner">
                                    <div className="pricing-table-main">
                                        <div className="pricing-table-header">
                                            <div className="pricing-table-title mt-12 mb-16 text-secondary">Lorem ipsum</div>
                                            <div className="pricing-table-price mb-24 pb-32"><span className="pricing-table-price-currency h3">$</span><span className="pricing-table-price-amount h1">29</span></div>
                                        </div>
                                    ...
                                    <div className="pricing-table-cta">
                                        <a className="button button-secondary button-block" href="#">Get started now</a>
                                    </div>
                                </div>
                            </div>
                            <div className="pricing-table is-revealing" style={{ visibility: 'visible' }}>
                                <div className="pricing-table-inner">
                                    <div className="pricing-table-main">
                                        <div className="pricing-table-header">
                                            <div className="pricing-table-title mt-12 mb-16 text-primary">Lorem ipsum</div>
                                            <div className="pricing-table-price mb-24 pb-32"><span className="pricing-table-price-currency h3">$</span><span className="pricing-table-price-amount h1">129</span></div>
                                        </div>
                                        <ul className="pricing-table-features list-reset text-xs mb-56">
                                            <li>
                                                <span className="list-icon">
                                    ...
                                    <div className="pricing-table-cta">
                                        <a className="button button-primary button-block" href="#">Get started now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
